      ...
      <div className="mx-auto max-w-[1600px] px-5 sm:px-8 grid md:grid-cols-2 gap-12">
        <div>
          ...
          <p className="mt-6 max-w-md text-lg text-foreground/70 text-pretty">
            From conference floors to private suites — a full network of stories,
            executives and brands we cover, on every continent we shoot.
          </p>
          <a href="#" className="pill-btn mt-8" style={{ background: "var(--ink)", color: "var(--background)" }}>
            Explore the work →
          </a>
        </div>
        ...
        <ul className="md:border-l md:border-foreground/15 md:pl-12">
          {COVERAGE.map((c, i) => (
            ...
            >
              <a href="#" className="flex items-center justify-between font-display text-3xl sm:text-4xl md:text-5xl transition-colors group-hover:text-accent">
                <span>{c}</span>
